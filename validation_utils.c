...
char *operator_name[]={"if,goto","if_not,goto","goto","-","not","bit_and","!*","+","=","*=","+","-","*","char to int","eq","lt","gt","geq","leq","neq","or","and","get rb","set rb","call", "param", "enter function", "enter statements", "leave function", "leave statements","return","add_shift"};
