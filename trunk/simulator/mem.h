...
int mem_fetch(PROC_MEM* mem, uint32_t addr,
              void *data, unsigned int data_size,
              int data_type);
int mem_set(PROC_MEM* mem, uint32_t addr,
            void *data, unsigned int data_size);
int mem_type(PROC_MEM* mem, uint32_t addr);
int mem_invalid(PROC_MEM* mem, uint32_t addr);// incalid return 0, else return -1
