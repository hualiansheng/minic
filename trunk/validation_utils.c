...
char *operator_name[]={"if,goto","if_not,goto","goto","-","not","&","!*","+","=","*=","+","-","*","char to int","eq","lt","gt","geq","leq","neq","or","and","get rb","set rb","call", "param", "enter function", "enter statements", "leave function", "leave statements","return","add_shift","int_to_char", "Imm", "minus_shift", "right_shift"};
