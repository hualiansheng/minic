...
char *operator_name[]={"if,goto","if_not,goto","goto","-","not","bit_and","!*","+","=","*=","+","-","*","char to int","eq","lt","gt","geq","leq","neq","or","and","get rb","set rb","call", "param", "enter function", "enter statements", "leave function", "leave statements","return","add_shift","int_to_char"};

extern basic_block *bblist;
extern func_block *fblist;
extern int block_num;

char *ins_name[] = {"", ".L", "ldw", "stw", "b.l", "mov", "add", "sub", "jump","cmpsub", "bne", "beq", "bsl", "beg", "bsg", "bel", "b", "cmoveq", "cmovsl", "cmoveg", "cmovel", "cmovne", "cmovsg"
};
