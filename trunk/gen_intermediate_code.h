...
enum operator{
	...
	equal_op, less_op, larger_op, eqlarger_op, eqless_op, noteq_op, or_op, and_op, get_rb, set_rb, call, param, enterF,enterS, leaveF, leaveS , return_op, adds_op, int_to_char_op, Imm_op, minuss_op, r_shift, c_str 
};
