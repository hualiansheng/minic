...
enum operator{
	...
	equal_op, less_op, larger_op, eqlarger_op, eqless_op, noteq_op, or_op, and_op, get_rb, set_rb, call, param, enterF,enterS, leaveF, leaveS , return_op, adds_op, int_to_char_op, Imm_op, minuss_op, r_shift, c_str, lshift_op 
};
...
typedef struct triple
{
	...
	union arg arg1;
	union arg arg2;
	int result_type;//0为char, 1为int, 2为char型指针, 3为int型指针
...
typedef struct stack_item//++ -- stack的item
{
	...
	int item_size;//0为char, 1为int, 2为char型指针, 3为int型指针
}stack_item;
